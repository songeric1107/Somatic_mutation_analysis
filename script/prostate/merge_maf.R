...
merged_mafs_TN_1000G_sub$Chrom_Pos <- paste(merged_mafs_TN_1000G_sub$Chromosome,merged_mafs_TN_1000G_sub$Start_Position,merged_mafs_TN_1000G_sub$End_Position,merged_mafs_TN_1000G_sub$Reference_Allele,merged_mafs_TN_1000G_sub$Tumor_Seq_Allele2,sep=":")
library(dplyr)
